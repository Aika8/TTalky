...
<nav class="navbar navbar-expand-lg navbar-dark mb-2" style="background-color: #180b7a">
    <style>
        .material-icons{
            display: inline-flex;
            vertical-align: top;
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="nav nav-pills ml-auto mr-5">
            <%
                if(!ONLINE){
            %>
            ...
            <li class="nav-item mr-5">
                <a class="nav-link text-light" href="faq.jsp">
            ...
            <li class="nav-item mr-5">
                <a class="nav-link text-light" href="about.jsp">
            ...
            <li class="nav-item">
                <a class="nav-link text-light" href="${pageContext.request.contextPath}/friend?search=<%=""%>">
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-people-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
                    </svg>
                    My Friends <%=!number.equals("0") ? "("+number+")": ""%>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-light" href="/profile">
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-image" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <i class="material-icons text-light">groups</i>
                </svg>
                Groups</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-light" href="/myPosts">
            ...
            <li class="nav-item">
                <a class="nav-link text-light" href="/chat?searchChat=">
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-image" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <i class="material-icons text-light">send</i>
                    </svg>
                    Messages <%=!numberChats.equals("0") ? "("+numberChats+")": ""%>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-light" href="/profile">
            ...
            <li class="nav-item">
                <a class="nav-link text-light" href="/profile">
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-image" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <i class="material-icons text-light">videocam</i>
                    </svg>Videos
                </a>
            </li>
            <li class="nav-item">
                ...
                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-image" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <i class="material-icons text-light">exit_to_app</i>
                </svg>
                    Logout
                </a>
            </li>
